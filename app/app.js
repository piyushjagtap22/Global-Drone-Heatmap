...
export function renderToDOM(container, data) {
 ...
 console.log()
  ...
  //       id: 'hex',
  //       data: data,
  //       getPosition: d => [parseInt(d[3]), parseInt(d[2])],
  //       getWeight: d => 1,
  //       radiusPixels: 15,
  ...
  //       threshold:0.16,
  //       intensity:1,
  //       colorRange:[[33,102,172,0], [103,169,207], [209,229,240], [253,219,199],[239,138,98],[178,4,43]],
...
export async function loadAndRender(container) {
  const data = await load(
    'https://raw.githubusercontent.com/kirtish10/PX4_Global_Home_Positions/master/10_may_global_home_positions.csv',
    CSVLoader
  );
